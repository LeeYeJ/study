...
n_splits = 5 # 디폴트값 5
kfold = KFold(n_splits = n_splits, shuffle=True,random_state=32185458) 
...
최적의 매개변수 : RandomForestRegressor(max_depth=8, min_samples_split=5)
최적의 파라미터 : {'min_samples_split': 5, 'max_depth': 8}
best_score_ : 0.8650802164059972
model.score : 0.7775103509876192
acc : 0.7775103509876192
최적 튠 ACC : 0.7775103509876192
걸린 시간 : 5.67 초
'''
