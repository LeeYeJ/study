...
from tensorflow.python.keras.layers import Dense,Conv2D,Flatten,MaxPooling2D, Dropout,Conv1D,Flatten
...
model = Sequential()
model = Sequential()
model.add(Conv1D(16,2,input_shape=(1024,3),activation='linear'))
