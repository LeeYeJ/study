#스플릿 해주고 핏에서validation_data=(x_val,y_val) 써서 검증해줌
import numpy as np
import pandas as pd
...
model.fit(x_train, y_train, epochs = 120, batch_size = 30, verbose = 1,validation_data=(x_val,y_val))
...
'''
Epoch 119/120
28/28 [==============================] - 0s 2ms/step - loss: 42.3280 - val_loss: 37.9420
Epoch 120/120
28/28 [==============================] - 0s 2ms/step - loss: 42.9600 - val_loss: 37.4135
5/5 [==============================] - 0s 724us/step - loss: 39.6219
loss :  39.62194061279297
r2 스코어 :  0.6170655539755547
RMSE :  53.50153315797733
'''
