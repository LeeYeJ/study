...
from tensorflow.python.keras.layers import Dense,Input,Flatten,Conv2D,LSTM,Conv1D,Flatten
...
conv1 모델
loss : 109.37643432617188
r2 스코어 : -1.3624417713855634
RMSE : 157.56308862931422
'''
