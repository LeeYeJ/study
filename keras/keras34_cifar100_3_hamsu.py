...
# 함수형 모델
input1 = Input(shape=(32,32,3)) # 스칼라 13개 벡터 1개
conv1 = Conv2D(8,2)(input1)
max1 = MaxPooling2D()(conv1)
conv2= Conv2D(filters=20,kernel_size=(2,2),activation='relu')(max1)
max2 = MaxPooling2D()(conv2)
flat1= Flatten()(max2)
dense1 = Dense(8,activation='relu')(flat1) #(input1) 이 레이어가 어디서 왔는지
