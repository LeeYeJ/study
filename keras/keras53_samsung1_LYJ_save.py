...
메일 제목: 이예지 [현대 2차] 180197.28원

첨부파일: keras53_samsung2_LYJ_submit.py 
첨부파일: keras53_samsung4_LYJ_submit.py
...
dense1 = LSTM(30,return_sequences=True,activation='relu', name='stock1')(input1)
lstm1 = LSTM(16)(dense1)
dense33 = Dense(30,activation='relu', name='stock3')(lstm1)
dense32 = Dense(15,activation='selu', name='stoc')(dense33)
# Drop1 = Dropout(0.3)(dense32)
dense3 = Dense(30, name='sto')(dense32)
...
dense11 = LSTM(20,return_sequences=True,name='weather1')(input2)
lstm1 = LSTM(16,activation='relu')(dense1)
dense13 = Dense(30,activation='relu',name='weather3')(lstm1)
dense14 = Dense(15,activation='selu',name='weather4')(dense13)
...
merge2 = Dense(18, activation='relu', name='mg2')(merge1)
# resh1 = Reshape(target_shape=(8,10))(merge2)
# conv1 = Conv1D(10,8)(resh1)
# resh2 = Flatten()(conv1)
dense3 = Dense(30,activation='relu', name='stock')(merge2)
merge3 = Dense(16, name='mg3')(dense3)#(resh2)
...
model.fit([x1_train,x2_train],y_train, epochs=700,batch_size=128,verbose=1)

# model.save('./_save/samsung/keras53_save_model_6.h5')
