...
#2.모델 구성
model= Sequential()
model.add(LSTM(8,input_shape=(784,1),activation='linear')) # 28*28로 표현해줘도됨
...
model.fit(x_train,y_train,epochs=100, batch_size=5120,validation_split=0.1, callbacks=[es,mcp])
end_time = time.time()
