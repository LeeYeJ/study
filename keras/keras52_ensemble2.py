...
x3_datasets = np.array([range(201,301),range(511,611),range(1300,1400)]) #온도, 습도, 강수
...
x1_train,x1_test,x2_train,x2_test,x3_train,x3_test,y_train,y_test=train_test_split(
    x1, x2,x3,y, train_size=0.7, random_state=546552
)
...
model.fit([x1_train,x2_train,x3_train],y_train, epochs=1000,batch_size=1)
