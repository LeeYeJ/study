...
from keras.layers import Dense, Dropout, LSTM,Conv1D,Flatten,Conv2D,MaxPooling2D,Reshape
...
model.add(Reshape(target_shape=(144,10))) #target_shape 어떻게 바꿀것인지/
model.add(Conv1D(10,3,padding='same'))
# model.add(LSTM(784))
model.add(Reshape(target_shape=(12,12,10)))
