...
x_train= x_train.reshape(784,26,3,1)
x_test= x_test.reshape(337,26,3,1)
test_csv = test_csv.reshape(1459,26,3,1) # test파일도 모델에서 돌려주니까 리쉐잎 해줘야됨.

model = Sequential()
model.add(Conv2D(7,(2,1),input_shape=(26,3,1)))
