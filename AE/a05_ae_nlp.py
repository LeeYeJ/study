...
hiden_layer_size = [516,256,128,256,516]     #모래시계 형태 
# hiden_layer_size = [816,924,1024,924,816]  #다이아 형태
# hiden_layer_size = [516,516,516,516,516]   #통나무 형태
...
model = autoencoder(hidden_layer_size=hiden_layer_size)
