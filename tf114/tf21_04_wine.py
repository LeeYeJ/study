...
#2. 모델구성
w1 = tf.compat.v1.Variable(tf.compat.v1.random_normal([13, 8]), name= 'weight1')    # (4,2) (2,a) (a.b) (b, 1) (4,1) 즉,  w의 중간층 layer의 shape에 맞춰주고 처음과 끝에만 x,y의 shape에 맞춰준다
...
w4 = tf.compat.v1.Variable(tf.compat.v1.random_normal([8, 3]), name= 'weight4')     
b4 = tf.compat.v1.Variable(tf.compat.v1.zeros([3]), name= 'bias4')     
