...
path_save_min = './_save/dacon_calories/min/'
...
# x['Weight_Status'] = le.fit_transform(x['Weight_Status'])
# test_csv['Weight_Status'] = le.fit_transform(test_csv['Weight_Status'])
...
for i in range(10000):
    ...
    for train_idx, test_idx in kf.split(x):
        ...
        def objective(trial):
            ...
            n_restarts_optimizer  = trial.suggest_int('n_restarts_optimizer', 1, 30)
