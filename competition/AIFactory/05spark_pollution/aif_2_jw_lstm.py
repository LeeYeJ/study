...
path_train = "D:/study/_data/AIFac_pollution/TRAIN/"
path_test = "D:/study/_data/AIFac_pollution/TEST_INPUT/"
path_train_AWS = "D:/study/_data/AIFac_pollution/TRAIN_AWS/"
path_test_AWS = "D:/study/_data/AIFac_pollution/TEST_AWS/"
...
train_all_dataset['month'] = train_all_dataset['month'].astype('float16').astype('Int16')
train_all_dataset['day'] = train_all_dataset['day'].astype('float16').astype('Int16')
train_all_dataset['hour'] = train_all_dataset['hour'].astype('float16').astype('Int16')
...
test_all_dataset['month'] = test_all_dataset['month'].astype('float16').astype('Int16')
test_all_dataset['day'] = test_all_dataset['day'].astype('float16').astype('Int16')
test_all_dataset['hour'] = test_all_dataset['hour'].astype('float16').astype('Int16')
