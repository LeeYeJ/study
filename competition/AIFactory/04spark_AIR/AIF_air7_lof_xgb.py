...
#2. 모델구성
model = GridSearchCV(XGBClassifier(), parameters, cv=5, refit=True, n_jobs=-1)
# model = XGBClassifier()
...
submission.to_csv(save_path+'submit_air_xgb.csv', index=False)
submission['label'] = y_pred
print(submission.value_counts())
...
# 최적의 파라미터: {'learning_rate': 0.05, 'max_depth': 10, 'n_estimators': 600}
# best_score: 0.901082543978349
# 0.9430591122점